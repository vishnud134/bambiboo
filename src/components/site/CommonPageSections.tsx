        ...
        <div className="container-page section-padding">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:gap-8">
            {pillars.map((p) => {
              ...
              return (
                <div key={p.title} className="group rounded-3xl border border-primary-foreground/20 bg-primary-foreground/5 p-6 md:p-8 flex flex-col justify-between h-full hover:bg-primary-foreground/10 hover:border-amber-300/40 transition-colors duration-300">
                  <div>
                    <div className="h-12 w-12 rounded-2xl bg-amber-300 text-primary grid place-items-center shadow-md">
