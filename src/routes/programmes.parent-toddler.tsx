...
const info: ProgrammeInfo = {
  ...
  schedule: [
    ...
    { time: "10–25 min", block: "Sensory Discovery — Hands-on exploration with age-appropriate materials." },
    { time: "25–40 min", block: "Music & Movement — Action songs, rhythm, dance and joyful movement." },
    { time: "40–55 min", block: "Story Time — Books, puppets and conversations that spark imagination." },
    { time: "55–70 min", block: "Creative Play — Painting, messy play, loose parts or simple crafts." },
    { time: "70–85 min", block: "Free Exploration — Children choose activities while parents observe, support and enjoy." },
    { time: "85–90 min", block: "Goodbye Circle — Songs, reflections and a calm transition home." },
  ],
  development: [
